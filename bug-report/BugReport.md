...
The following is a list of bugs identified during manual exploratory testing of Sauce Demo, primarily using the problem_user account (except for BUG-010).
